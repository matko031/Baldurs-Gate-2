...
SetPrivateProfileString('Game Options','Message Box Top','46')
...
SetPrivateProfileString('MOVIES','HEXXATDR','1')
...
SetPrivateProfileString('Graphics','renderer','Intel(R) UHD Graphics 620')
...
SetPrivateProfileString('Program Options','Volume Voices','53')
SetPrivateProfileString('Program Options','Translucent Shadows','1')
SetPrivateProfileString('Program Options','Volume SFX','20')
...
SetPrivateProfileString('Multiplayer','Session Name','kale')
SetPrivateProfileString('Multiplayer','Pausing Dialog','0')
SetPrivateProfileString('Multiplayer','Import Character','7')
SetPrivateProfileString('Multiplayer','TCP/IP Address','192.168.43.59')
SetPrivateProfileString('Multiplayer','Player Name','Vhagar')
SetPrivateProfileString('Multiplayer','Default Permissions','00000001')
SetPrivateProfileString('Multiplayer','Last Protocol Used','1')
SetPrivateProfileString('Multiplayer','Session Password','jediburaniju')
